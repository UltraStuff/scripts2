...
do -- Example UI
	local Window = library:AddWindow("Furk - All Star Tower Defense", {
		main_color = Color3.fromRGB(0, 0, 0),
		min_size = Vector2.new(240, 200),
		toggle_key = Enum.KeyCode.RightShift,
		can_resize = true,
	})
